    ...
    <section id="problem" className="min-h-screen grid-texture py-32">
      <div className="container mx-auto px-6">
        ...
        <motion.p
          ...
          className="font-[family-name:var(--font-jakarta)] text-[var(--text-primary)] text-xl md:text-2xl max-w-4xl mt-8 leading-relaxed"
        ...
        {/* Pain Points Grid */}
        <div className="grid md:grid-cols-2 gap-6 mt-16 max-w-6xl">
